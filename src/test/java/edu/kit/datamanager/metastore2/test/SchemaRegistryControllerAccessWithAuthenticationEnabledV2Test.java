...
public class SchemaRegistryControllerAccessWithAuthenticationEnabledV2Test {
  ...
  public void testCreateRecordWithoutAuthentication() throws Exception {
    ...
    DataResource record = SchemaRegistryControllerV2Test.createDataResource4Schema(schemaId);
