...
public interface IMetadataControllerV2 extends InfoContributor {
  ...
  ResponseEntity createRecord(
          @Parameter(description = "Json representation of the datacite record.", required = true) @RequestPart(name = "record", required = true) final MultipartFile dataciteRecord,
  ...
  ResponseEntity updateRecord(
          ...
          @Parameter(description = "JSON representation of the metadata record.", required = false) @RequestPart(name = "record", required = false) final MultipartFile dataciteRecord,
