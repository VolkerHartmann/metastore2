  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    HttpSecurity httpSecurity = http.authorizeHttpRequests(
                    authorize -> {
                     ...
                     if (!applicationProperties.getPostEnabledForGroup().isBlank()) {
                        logger.info("Post enabled for group '{}'!", applicationProperties.getPostEnabledForGroup());
                        authorize.
                                requestMatchers(HttpMethod.POST, "/api/v1/schemas/").hasAnyAuthority(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v2/schemas/").hasAnyAuthority(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v1/metadata/").hasAnyAuthority(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v2/metadata/").hasAnyAuthority(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v1/schemas/").hasAnyRole(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v2/schemas/").hasAnyRole(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v1/metadata/").hasAnyRole(applicationProperties.getPostEnabledForGroup()).
                                requestMatchers(HttpMethod.POST, "/api/v2/metadata/").hasAnyRole(applicationProperties.getPostEnabledForGroup());
                      }
